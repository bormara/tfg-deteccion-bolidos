...
export class DialogoTutorialComponent implements OnInit {
  ...
  i;
  ubicacion1 = 'http://' + environment.urlApi + '/api/media/eventos/cam43-UPM-MAD-2019-10-16--21-33-20/evento.mp4';
  ubicacion2 = 'http://' + environment.urlApi + '/api/media/eventos/cam43-UPM-MAD-2019-10-16--00-37-22/evento.mp4';
  ubiaccion3 = 'http://' + environment.urlApi + '/api/media/eventos/cam43-UPM-MAD-2019-10-16--21-30-47/evento.mp4';
  tutorial = [
    {
    ...
    },
    {
      imagen: '/assets/icons/Tutorial1.jpeg',
      tipo: '/video/mp4',
      texto: 'En este primer video puedes ver un avión sobrepasando el cielo\n' +
        'Sabemos que es un avión porque parpadea'
    },
    {
      imagen: '/assets/icons/Tutorial1.jpeg',
      tipo: '/video/mp4',
      texto: 'En este segundo video puedes ver los efectos sobre la cámara de un rayo\n' +
        'Sabemos que es un rayo porque se produce un cambio subido en la luz de la imagen, en algunos casos también se verá el propio rayo'
    },
    {
      imagen: '/assets/icons/Tutorial1.jpeg',
      tipo: '/video/mp4',
    ...
    },
    {
      ...
      texto: 'Muchas gracias por tu atención y ayuda!\n' +
        'Suerte!\n' +
        'Pulsa fuera del dialogo para comenzar'
    }
  ];
